...
warpTransition.transitionSpeeds = {
    ...
    [warpTransition.TRANSITION_IRIS_OUT ] = 28, -- How quickly the radius of the iris out shrinks.
    [warpTransition.TRANSITION_MOSAIC   ] = 32, -- How long it takes to fade in/out.
